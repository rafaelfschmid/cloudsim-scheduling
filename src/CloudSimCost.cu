#include <jni.h>
//#include <iostream>
#include "CloudSimCost.h"
#include <cuda.h>
#include <moderngpu/kernel_segsort.hxx>

JNIEXPORT void JNICALL Java_CloudSimCost_segmented_1sort (JNIEnv * env, jobject obj,
...
JNIEXPORT void JNICALL Java_CloudSimCost_segmented_1sort_1desc (JNIEnv * env, jobject obj,
		jfloatArray ma, jintArray ta, jintArray seg, jint t, jint m) {
